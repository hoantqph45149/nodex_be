...
export const sendResetEmail = async (email, resetURL) => {
 ...
 const message = {
  from:  `Nodex Support <${process.env.EMAIL_USER}>`,
  to: email,
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="
              background:linear-gradient(135deg,#000000,#1f1f2e,#3b3b98);
              padding:40px 30px;
            ">

              <img 
                src="https://res.cloudinary.com/du2m9ntlf/image/upload/v1772715592/an7thoklw4rwlxg1w0iq.png" 
                alt="Nodex Logo"
                width="130"
